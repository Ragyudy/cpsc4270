...
// arguments. It formats and prints an error message, then exits.
...
// After extraction, date is: "Fri Jun 9 1995" hour is:
// "10:15:55"
...
string nowstring = ctime(&now); // Convert to string form.
string hour =
nowstring.substr(11, 8); // Extract hour, minutes, seconds.
return hour;
}
// ---------------------------------------------------------------------
// Menu handling
...
cin >> choice;
if (valid.find(choice) != string::npos)
break;
